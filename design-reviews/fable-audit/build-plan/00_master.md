...
- **Files here:** `00_master.md` (this map — read, don't fire) · `DECISIONS.md` (cross-window ledger) · `HANDOFF.md` (checkpoint state) · **the six copy-paste phase prompts `1.md` → `6.md`** (fire in order) · `reports/` (per-phase evidence + captures). Prompt→phase: `1.md`=P1 Floor · `2.md`=P2 Front Door · `3.md`=P3 Winning · `4.md`=P4 Study Report · `5.md`=P5 Ghost · `6.md`=P6 Close-Out.
